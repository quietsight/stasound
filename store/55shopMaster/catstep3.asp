...
if (session("append")="1") then
	if (R1=0) and (R2=0) then
		...
		response.redirect "catstep2.asp?msg=" & msg & mtemp
	end if
else
	if (R1=0) then
...
%>
<form method="post" action="catstep4.asp" class="pcForms">
...
<tr>
		...
		<input type="button" name="backstep" value="<< Back to Step 2" onClick="location='catstep2.asp?a=1<%=mtemp%>';">&nbsp; 
