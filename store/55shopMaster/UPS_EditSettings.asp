...
%>
<% pageTitle="UPS OnLine&reg; Tools Shipping Configuration - Edit Settings" %>
<% Section="shipOpt" %>
...
<table class="pcCPcontent">
	<tr>
		<td>
			...
			<% response.redirect "UPS_EditSettings.asp?s=1&msg=" & server.URLEncode("UPS Shipping Settings updated successfully. <a href=viewShippingOptions.asp>Manage shipping options</a>.")
		end if
		...
		%>
			...
			<form name="form1" method="post" action="UPS_EditSettings.asp" onSubmit="return Form1_Validator(this)" class="pcForms">   
				<table class="pcCPcontent">
					<tr>
...
*Use	only	alphanumeric	Characters	- &quot;&amp;&quot; symbols are not allowed.</p></td>
                    ...
                    <tr>
                        <td colspan="2" bgcolor="#FFFFFF"><h2>Account Based (Negotiated) Rates</h2> </td>
                    </tr>
                    <tr> 
						<td colspan="2">
						...
						%>
                        	<p>UPS needs to be active for you to be able to use this feature. Please activate at least one UPS shipping service.</p>
                        <%
						else
							...
							%>
							<p>If you have an account with UPS that has been granted special rates (referred to as <em>Account Based Rates</em> or <em>Negotiated Rates</em>), you will need to setup your Online Tools account to use those <em>Negotiated Rates</em>. Provide UPS with the following credentials and ask them to match your UPS negotiated rates account with the Online Tools account created in ProductCart.</p>
							<br>
                    ...
                    <tr> 
                        <td colspan="2">
                        <p style="margin-top: 15px;">Once you have completed the above step, you can enable Account Based Rates (ABR) below. If you do not have ABR enabled with UPS, activating this setting will not allow rates to be returned in the storefront.</p><br>
                        <p>
                        <label>
