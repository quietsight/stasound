		...
		%>
			<ul class="TabbedPanelsTabGroup">
				...
				<li class="TabbedPanelsTabButtons" tabindex="1000">
					...
					<input type="submit" name="modify" value="Modify" onClick="OpenHS();" class="submit2">
                    <%
                    '// Loading Window
					...
					<input type="checkbox" name="runSubCats" value="1" class="clearBorder"> Apply to sub-categories
					</div>
					<div style="text-align: center;">
					<input type="submit" name="delete" value="Delete" onclick="return confirm('Are you sure you want to delete this category? If the category contains any products, you will first be prompted to remove them from it. If no products have been assigned, the category will be immediately deleted.')">
					&nbsp;
