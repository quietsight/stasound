...
if UseSpecial="1" then
	...
	session("srcCust_where")=""
end if	

if src_FormTitle1="" then
	src_FormTitle1="Search a customer"
end if
...
myConn.connect("xml_srcCustsCount.asp", "POST", GetAllValues(document.ajaxSearch), fnWhenDone);
}
...
<form name="ajaxSearch" method="post" action="srcCusts.asp" class="pcForms">
...
<table class="pcCPsearch">
	...
	<tr>
		<td width="31%">State Code:</td>
		<td width="69%">  
			<input type=text name="key7" size="50" value="" onblur="javascript:runXML();">
		</td>
	</tr>
	
	<tr>
		<td width="31%">Province:</td>
		<td width="69%">  
			<input type=text name="key8" size="50" value="" onblur="javascript:runXML();">
		</td>
	</tr>
	...
	<tr>
		...
		<td width="69%">  
			<input type=text name="key9" size="50" value="" onblur="javascript:runXML();">
		</td>
	</tr>
	
	<tr>
		<td width="31%">Country Code:</td>
		<td width="69%">  
			<input type=text name="key10" size="50" value="" onblur="javascript:runXML();">
		</td>
	</tr>
	<tr>
		<td width="31%">&nbsp;</td>
		<td width="69%">  
			<input type="checkbox" name="key11" value="1" class="clearBorder" onclick="javascript:if (document.ajaxSearch.key10.value!='') runXML();"> Exclude the country code above
		</td>
	</tr>
	...
	<tr>
		...
		<td width="69%">  
			<input type=text name="key6" size="50" value="" onblur="javascript:runXML();">
		</td>
	</tr>
	...
	<tr>
		...
		<td>
			<select name="order">
				<option value="2">CustomerID ascending</option>
				<option value="3">CustomerID descending</option>
	...
	<tr>
		<td colspan="2" align="center">
			<br>
			<input name="Submit" type="submit" class="ibtnGrey" value="<%=src_Button1%>" id="searchSubmit">
		</td>
	</tr>
</table>
</form>
