...
response.redirect "cwstep2-xls.asp?append=" & request("append") & "&movecat=" & request("movecat")
end if%>
...
<%
	...
	<form method="post" action="cwstep3.asp" class="pcForms">
	<table class="pcCPcontent">
    <tr>
    	<td colspan="2"></td>
    </tr>
