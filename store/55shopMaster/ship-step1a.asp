...
if ((right(ucase(filepathname),4)=".CSV") or (right(ucase(filepathname),4)=".XLS")) AND IsUploadAllowed(filepathname) then
	...
	Sub BuildUploadRequest(RequestBin)
		...
		Response.redirect "ship-index_import.asp?s=1&nextstep=1&msg=The data file " & ucase(lgCSV) & " was uploaded successfully."
	end if
else
...
If InValidCSV>0 then
	...
	'//END DETAILED MSG
Else
	response.redirect "ship-index_import1.asp?s=0&msg=You did not select a file to upload."
end if
