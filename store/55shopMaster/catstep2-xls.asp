...
response.redirect "catstep2.asp?append=" & request("append") & "&movecat=" & request("movecat")
end if%>
...
<tr>
   ...
   next
	...
	%>
    <form method="post" action="catstep3-xls.asp" class="pcForms">
    <table class="pcCPcontent">
    	<tr>
        	<td colspan="2">
			Use the drop-down menus below to map existing fields in your category database, located on the left side of the page under 'From' to ProductCart database fields, which are located on the right side of the page under 'To'.
	</td>
</tr>
<tr>
