...
'// Order number is valid
	...
	pcOrd_GcCode=rs("pcOrd_GcCode")  
	pcOrd_GcUsed=rs("pcOrd_GcUsed") 
	...
	do while not rsOrdObj.eof
		...
		pcPSiGateXMLPostData=pcPSiGateXMLPostData&"<Item>"
			pcPSiGateXMLPostData=pcPSiGateXMLPostData&"<ItemID>"&count&"</ItemID>"
			pcPSiGateXMLPostData=pcPSiGateXMLPostData&"<ItemDescription>"&pdescription&"</ItemDescription>"
			pcPSiGateXMLPostData=pcPSiGateXMLPostData&"<ItemQty>"&pquantity&"</ItemQty>"
			pcPSiGateXMLPostData=pcPSiGateXMLPostData&"<ItemPrice>"&tmpFinalRowPrice&"</ItemPrice>"
		pcPSiGateXMLPostData=pcPSiGateXMLPostData&"</Item>"
		'~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	if pcv_strFinalPayCharge<>0 then
		pcPSiGateXMLPostData=pcPSiGateXMLPostData&"<Item>"
			pcPSiGateXMLPostData=pcPSiGateXMLPostData&"<ItemID>PC</ItemID>"
			pcPSiGateXMLPostData=pcPSiGateXMLPostData&"<ItemDescription>Processing Charges</ItemDescription>"
			pcPSiGateXMLPostData=pcPSiGateXMLPostData&"<ItemQty>1</ItemQty>"
			pcPSiGateXMLPostData=pcPSiGateXMLPostData&"<ItemPrice>"&pcv_strFinalPayCharge&"</ItemPrice>"
		pcPSiGateXMLPostData=pcPSiGateXMLPostData&"</Item>"
	end if
	...
	if piRewardValue<>0 then
		pcPSiGateXMLPostData=pcPSiGateXMLPostData&"<Item>"
			pcPSiGateXMLPostData=pcPSiGateXMLPostData&"<ItemID>RP</ItemID>"
			pcPSiGateXMLPostData=pcPSiGateXMLPostData&"<ItemDescription>Points Discount</ItemDescription>"
			pcPSiGateXMLPostData=pcPSiGateXMLPostData&"<ItemQty>1</ItemQty>"
			pcPSiGateXMLPostData=pcPSiGateXMLPostData&"<ItemPrice>-"&piRewardValue&"</ItemPrice>"
		pcPSiGateXMLPostData=pcPSiGateXMLPostData&"</Item>"
	end if
	...
	if pOrd_GWTotal<>0 then
		pcPSiGateXMLPostData=pcPSiGateXMLPostData&"<Item>"
			pcPSiGateXMLPostData=pcPSiGateXMLPostData&"<ItemID>GW</ItemID>"
			pcPSiGateXMLPostData=pcPSiGateXMLPostData&"<ItemDescription>Gift Wrapping</ItemDescription>"
			pcPSiGateXMLPostData=pcPSiGateXMLPostData&"<ItemQty>1</ItemQty>"
			pcPSiGateXMLPostData=pcPSiGateXMLPostData&"<ItemPrice>"&pOrd_GWTotal&"</ItemPrice>"
		pcPSiGateXMLPostData=pcPSiGateXMLPostData&"</Item>"
	end if
	...
	'pcOrd_GcCode=rs("pcOrd_GcCode")  
	'pcOrd_GcUsed=rs("pcOrd_GcUsed") 
	if pcOrd_GcUsed<>0 then
		pcPSiGateXMLPostData=pcPSiGateXMLPostData&"<Item>"
			pcPSiGateXMLPostData=pcPSiGateXMLPostData&"<ItemID>GC</ItemID>"
			pcPSiGateXMLPostData=pcPSiGateXMLPostData&"<ItemDescription>Gift Certificate</ItemDescription>"
			pcPSiGateXMLPostData=pcPSiGateXMLPostData&"<ItemQty>1</ItemQty>"
			pcPSiGateXMLPostData=pcPSiGateXMLPostData&"<ItemPrice>-"&pcOrd_GcUsed&"</ItemPrice>"
		pcPSiGateXMLPostData=pcPSiGateXMLPostData&"</Item>"
	end if
	...
	if pcv_strFinalServiceCharge<>0 then
		pcPSiGateXMLPostData=pcPSiGateXMLPostData&"<Item>"
			pcPSiGateXMLPostData=pcPSiGateXMLPostData&"<ItemID>HC</ItemID>"
			pcPSiGateXMLPostData=pcPSiGateXMLPostData&"<ItemDescription>Handling</ItemDescription>"
			pcPSiGateXMLPostData=pcPSiGateXMLPostData&"<ItemQty>1</ItemQty>"
			pcPSiGateXMLPostData=pcPSiGateXMLPostData&"<ItemPrice>"&pcv_strFinalServiceCharge&"</ItemPrice>"
		pcPSiGateXMLPostData=pcPSiGateXMLPostData&"</Item>"
	end if
	...
	ItemTotal = pcv_strFinalTotal - (pcv_strFinalShipCharge+pcv_strFinalServiceCharge+pcv_strFinalTax+pcv_strFinalPayCharge)
