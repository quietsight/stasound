...
<body style="margin: 0;">
<div id="pcMain">
<form method="post" name="Form1" action="sb_CustCancelSub.asp?action=add" onSubmit="return Form1_Validator(this)" class="pcForms">
...
<table class="pcMainTable">
    ...
    <%ELSE%>
		...
		<%ELSE%>            
				...
				<% End If %>
                <tr>
                	<td colspan="2"><h2>Cancel Subscription</h2></td>
                </tr>
				<tr>
					<td valign="top">
