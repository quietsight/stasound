...
<table class="pcShowProductsH">
	...
	<tr>
		...
		<% If pcf_AddToCart(pIdProduct)=True Then %><p class="pcShowProductLink"><a href="instPrd.asp?idproduct=<%=pIdProduct%>&pSubscriptionID=<%=pSubscriptionID%>"><img src="<%=rslayout("add2")%>" alt="<%=dictLanguage.Item(Session("language")&"_altTag_2")& pDescription %>"></a></p><% End If %> 
		</td>
	</tr>
</table>