...
function InnovaEditorUtil()
  ...
  for(var i=0;i<oScripts.length;i++)
    ...
    if(sSrc.indexOf("/editor.js")!=-1) this.scriptPath=oScripts[i].src.replace(/editor.js/ig,"");
    }
...
function InnovaEditor(oName)
  ...
  for(var i=0;i<oScripts.length;i++)
    {
    var sSrc=oScripts[i].src.toLowerCase();
    if(sSrc.indexOf("/editor.js")!=-1) this.scriptPath=oScripts[i].src.replace(/editor.js/,"");
    }
