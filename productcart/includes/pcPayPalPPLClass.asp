...
Class pcPayPalClass
	...
	Public Function hash_call(methodName, nvpStr)	
		...
		AddNVP "VENDOR", pcPay_PayPalAd_Vendor
	...
	Public Sub pcs_SetAllVariables()
		...
		'// Set Local Var
		pcPay_PayPalAd_User=trim(rsPayPalVar("v_User"))
		pcPay_PayPalAd_User=enDeCrypt(pcPay_PayPalAd_User, scCrypPass)
		pcPay_PayPalAd_Partner=trim(rsPayPalVar("v_Partner"))
		pcPay_PayPalAd_Password = trim(rsPayPalVar("v_Password"))
		pcPay_PayPalAd_Password=enDeCrypt(pcPay_PayPalAd_Password, scCrypPass)
		pcPay_PayPalAd_Vendor=trim(rsPayPalVar("v_Vendor"))
		pcPay_PayPalAd_Vendor=enDeCrypt(pcPay_PayPalAd_Vendor, scCrypPass)
		pcPay_PayPalAd_Sandbox = trim(rsPayPalVar("pfl_testmode"))
		pcPay_PayPalAd_TransType = trim(rsPayPalVar("pfl_transtype"))
		pcPay_PayPalAd_CSC = trim(rsPayPalVar("pfl_CSC"))
