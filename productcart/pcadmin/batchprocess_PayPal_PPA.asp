		...
		if cdbl(pAmount)>0 then		
			...
			if not IsEmpty(pidAuthOrder) then
				...
				If scPPLogging = "1" Then
					...
					OutputFile.WriteLine "Request from ProductCart to PayPal for PayPal Payments Advanced Express Capture"
				...
				'//PAYPAL LOGGING START
				If scPPLogging = "1" Then
					OutputFile.WriteLine "Response from PayPal to ProductCart for PayPal Payments Advanced Express Capture"
