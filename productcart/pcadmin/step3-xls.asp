...
if (session("append")="1") then
	if (R1=0) then
		...
		response.redirect "step2-xls.asp?msg=" & msg & mtemp
	end if
else
...
%>
<form method="post" action="step4-xls.asp" class="pcForms">
...
<tr>
	<td colspan="2">
		...
		<input type="button" name="backstep" value="<< Back to Step 2" onClick="location='step2-xls.asp?a=1<%=mtemp%>';">&nbsp; 
