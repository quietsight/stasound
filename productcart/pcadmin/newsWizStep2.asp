...
%>
<% pageTitle="Newsletter Wizard - Review Selected Customers" %>
<% section="mngAcc" %>
<!--#include file="AdminHeader.asp"-->
<form name="Form1" method="post" action="newsWizStep2.asp?action=update" class="pcForms">
...
<tr>
	<td><p>You can <strong>edit/add addresses</strong> using the field above. When adding addresses, please make sure to place one email address per line. When you are done, click on &quot;Update&quot;.</p></td>
</tr>
<tr>
	<td align="center">&nbsp;</td>
</tr>
<tr>
	<td align="center">
		...
		&nbsp;
		<%end if%>
		<input type="button" value="Continue" onClick="location='newsWizStep3.asp?pagetype=<%=pcv_PageType%>'" class="submit2">
		&nbsp;
		<input type="button" name="back" value="Back" onClick="location='<%if pcv_pageType<>"" then%>sds_newsWizStep1.asp?pagetype=<%=pcv_pageType%><%else%>newsWizStep1.asp<%end if%>'" class="ibtnGrey">
	</td>
</tr>
<tr>
