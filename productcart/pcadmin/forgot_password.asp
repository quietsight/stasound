...
If session("ForgotAttackCount") < 5 Then
    ...
    <form method="post" name="forgot_password" class="pcForms">
        <table class="pcCPcontent">
            <tr> 
                <td colspan="2">&nbsp;<% validateError %></td>
            </tr>
            <tr> 
                <td width="15%" align="right">Admin User Name:</td>
                <td width="85%">
                <% textbox "user", "",25, "textbox"
    ...
    <script type="text/javascript">
     document.forgot_password.user.focus();
    </script>
<%Else%>
