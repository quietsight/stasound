...
dim CSVRecord(100),f, query, conntemp, rstemp, rstemp1,TopRecord(100), IDcustom(2), Customcontent(2)
...
call openDb()
	...
	TotalCSVlines=TotalCSVlines+1
		...
		'Maybe Customer Text Fields have commas or "End Text Line - VBCrLf" characters, fix these problems
	 	i=0
	 	j=0
	 	Do while j<fields
	 	if i>ubound(a) then
