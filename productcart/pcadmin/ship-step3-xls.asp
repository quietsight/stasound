...
if (R1<3) then
	...
	response.redirect "ship-step2-xls.asp?msg=" & msg & mtemp
end if
...
<div style="margin: 10px;">Please make sure that the database fields are mapped
correctly. If not, click &quot;Back to Step 2&quot; button to try again.</div>
<form method="post" action="ship-step4-xls.asp" class="pcForms">
    <table >
        <table class="pcCPcontent">
            <tr>
                <th width="50%">From:</th>
