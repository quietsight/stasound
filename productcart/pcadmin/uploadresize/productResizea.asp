        ...
        <table width="90%" border="0" cellspacing="0" cellpadding="3" align="center">
          ...
          <tr> 
            ...
            <td width="80%"><font face="Arial, Helvetica, sans-serif" size="2"> 
              <input type="text" name="thumbnailsize" size="3" maxlength="3" class="ibtng" value="100"> pixels
              </font></td>
          </tr>
          <tr> 
            <td width="20%" nowrap> 
            ...
            <td width="80%"><font face="Arial, Helvetica, sans-serif" size="2"> 
              <input type="text" name="generalsize" size="3" maxlength="3" class="ibtng" value="200"> pixels
              </font></td>
          </tr>
          <tr> 
            <td width="20%" nowrap> 
            ...
            <td width="80%"><font face="Arial, Helvetica, sans-serif" size="2"> 
              <input type="text" name="detailsize" size="3" maxlength="3" class="ibtng" value="350"> pixels
              </font></td>
          </tr>		  		     
          <tr> 
            <td width="20%" nowrap> 
