<% pageTitle = "Product Import Wizard - Upload data file" %>
<% section = "products" %>
...
<form method="post" enctype="multipart/form-data" action="step1a.asp" onSubmit="return Form1_Validator(this)" class="pcForms">
<table class="pcCPcontent">
	<tr>
    ...
    <tr> 
        <th>CSV/XLS product data file</th>
    </tr>
    <tr>
    	<td colspan="2" class="pcCPspacer"></td>
    </tr>
