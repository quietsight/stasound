...
if (session("append")="1") then
	if (R1=0) then
		...
		response.redirect "cwstep2-xls.asp?msg=" & msg & mtemp
	end if
else
	if r1+r2+r3<>3 then
...
<form method="post" action="cwstep4-xls.asp" class="pcForms">
...
<tr>
    ...
    <tr>
        <td colspan="2">           
            ...
            <input type="button" name="backstep" value="<< Back to Step 2" onClick="location='cwstep2-xls.asp?a=1<%=mtemp%>';">
