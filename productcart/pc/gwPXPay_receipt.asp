...
if strSuccess="1" then
	...
	session("GWOrderID")=strMerchantReference
...
if strSuccess="0" then
	...
	response.redirect "msgb.asp?message="&server.URLEncode("<b>Error&nbsp;:</b> "& strDpsTxnRef &"<br><br><a href="""&tempURL&"?psslurl="&session("redirectPage")&"&idCustomer="&session("idCustomer")&"&idOrder="&session("GWOrderID")&"&ordertotal="&strAmountSettlement&""">Back</a>")
	Response.end
