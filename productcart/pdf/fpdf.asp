<!--#include file="includes/adminv.asp"-->
<!--#include file="includes/Basics.asp"-->
...
this.SetFont=function SetFont(xfamily , xstyle , xsize)
	...
	this.LoadExtension=function LoadExtends(path){
		this._LoadExtension(this.EXTENDSPATH +path+".js");
	}
	this.LoadModels=function LoadModels(path){
		this._LoadExtension(this.MODELSPATH +path+".js");
	}
